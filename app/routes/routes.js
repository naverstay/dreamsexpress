...
//     if (req.params.id) {
//         res.render('product', {user: req.client_info, all_productsreq.all_products, fav_html: req.fav_html, title: 'Express', id: req.params.id});
//     } else {
//         res.render('products', {user: req.client_info, all_productsreq.all_products, fav_html: req.fav_html, title: 'Express'});
//     }
// });
...
// app.post('/q_search', productsController.filter);
    ...
    app.post('/user', function (req, res) {
        ...
        var hash = req.body.hash.replace(/.*\//ig, ''),
...
// @formatter:on
    ...
    app.post('/upload/:path', function (req, res) {
        var files = [], ret_files = [],
            dir = prod_upload_dir + (req.params.path.length ? req.params.path + '/' : '');
